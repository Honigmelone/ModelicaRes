...
def eliminate_parameters_from_ds_file(filename, savepath, exclude_paras, eliminate_auxiliar_parmateres = True):
    """
    ...
    :param eliminate_auxiliar_parmateres: Boolean, default True
    ...
    if eliminate_auxiliar_parmateres:
